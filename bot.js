...
(function() {
  ...
  handleNewSong = function(obj) {
    ...
    if (data.currentsong === null) {
      ...
      API.sendChat("/em:" + currentDJ.username + " Just played " + data.currentsong.title + " by " + data.currentsong.author + ". Stats: Woots: " + data.currentwoots + ", Mehs: " + data.currentmehs + ", Added: " + data.currentcurates + ".");
      data.newSong();
      document.getElementById("button-vote-positive").click();
    }
    if (data.forceSkip) {
